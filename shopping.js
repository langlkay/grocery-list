...
//this function will update list by adding items to cart
...
//this function deletes the entire item division
...
addBtn.addEventListener("click", ()=> {
    ...
    if(item) {
        ...
        alert("PLEASE enter an item name NOW!")
    }
...
function buildItem(emoji, item){
    ...
    //add classes and text to elements
    ...
    //now add all elements to the div
    itemDiv.append(emojiSpan, itemSpan, bagIcon, trashIcon);

    return itemDiv;

}// end of buildItem function